fisica: fisica.h fisica.c fisica-test.c
	gcc -o fisica.bin fisica.h fisica.c fisica-test.c -Wall 

comutador: comutador.h comutador.c comutador-test.c
	gcc -o comutador.bin comutador.h comutador.c comutador-test.c fisica.h fisica.c -Wall

enlace: fisica.h fisica.c enlace.h enlace.c enlace-test.c comutador.h comutador.c 
	gcc -o enlace.bin enlace.h enlace.c enlace-test.c fisica.h fisica.c -Wall
